...
use Ayasoftware\ReviewApi\Api\GetProductReviewsInterface;
...
use Ayasoftware\ReviewApi\Model\Converter\Review\ToDataModel as ReviewConverter;
...
class GetProductReviews implements GetProductReviewsInterface
{
     ...
     * @param string $sku
     *
     * @return array|\Ayasoftware\ReviewApi\Api\Data\ReviewInterface[]
     */
