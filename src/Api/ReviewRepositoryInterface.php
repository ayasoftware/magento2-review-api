...
interface ReviewRepositoryInterface
{
     ...
     * Save review.
     *
     * @param \Ayasoftware\ReviewApi\Api\Data\ReviewInterface $review
     *
     * @return \Ayasoftware\ReviewApi\Api\Data\ReviewInterface
     * @throws \Magento\Framework\Exception\CouldNotSaveException
     * @throws \Magento\Framework\Exception\NoSuchEntityException
     */
    public function save(ReviewInterface $review): \Ayasoftware\ReviewApi\Api\Data\ReviewInterface;
     ...
     * @throws \Magento\Framework\Exception\NoSuchEntityException
     */
    public function get(int $reviewId): \Ayasoftware\ReviewApi\Api\Data\ReviewInterface;

    /**
     * Lists the review items that match specified search criteria.
     *
     * @param \Magento\Framework\Api\SearchCriteriaInterface|null $searchCriteria
     * @return \Ayasoftware\ReviewApi\Api\Data\ReviewSearchResultInterface
     */
    public function getList(
        ?SearchCriteriaInterface $searchCriteria = null
    ): \Ayasoftware\ReviewApi\Api\Data\ReviewSearchResultInterface;
